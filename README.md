...
- Version 0.1.5 adds Ghidra 12.1.3 support. Because the official 12.1.3 ZIP omits the `linux_arm_64`, `mac_arm_64`, and `mac_x86_64` decompiler directories, this release builds matching `decompile` / `sleigh` binaries from the official 12.1.3 source tag and publishes both an overlay and a ready-to-use patched Ghidra bundle.
