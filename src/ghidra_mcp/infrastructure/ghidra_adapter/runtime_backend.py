...
class RuntimeBackend:
    ...
    def create_session(
        ...
        *,
        ...
        return self._target_lifecycle.create_session(
            name,
            project_location,
    ...
    def register_target(
        ...
        *,
        ...
        return self._target_lifecycle.register_target(
            name,
            project_location,
            project_name=project_name,
        )
    ...
    def list_targets(self) -> List[Dict[str, Optional[str]]]:
        return self._target_lifecycle.list_targets()

    def list_programs(self, name: str):
        return self._target_lifecycle.list_programs(name)
    ...
    def load_program(
        ...
        return self._target_lifecycle.load_program(name, domain_path)

    def import_program(self, name: str, binary_path: str) -> str:
        return self._target_lifecycle.import_program(name, binary_path)

    def get_project_sync_status(self, name: str, *, domain_path: str | None = None) -> Dict[str, Any]:
        return self._sync_operations.get_project_sync_status(name, domain_path=domain_path)
    ...
    def checkout_project_program(
        ...
        *,
        ...
        return self._sync_operations.checkout_project_program(
            name,
            exclusive=exclusive,
            domain_path=domain_path,
        )
    ...
    def add_project_program_to_version_control(
        ...
        *,
        ...
        return self._sync_operations.add_project_program_to_version_control(
            name,
            comment,
    ...
    def commit_project_program(
        ...
        *,
        ...
        return self._sync_operations.commit_project_program(
            name,
            message,
            keep_checked_out=keep_checked_out,
    ...
    def pull_project_program(
        ...
        *,
        ...
        return self._sync_operations.pull_project_program(
            name,
    ...
    def undo_checkout_project_program(
        ...
        *,
        ...
        return self._sync_operations.undo_checkout_project_program(
            name,
    ...
    def terminate_project_program_checkout(
        ...
        *,
        ...
        return self._sync_operations.terminate_project_program_checkout(
            name,
            checkout_id,
            domain_path=domain_path,
        )
    ...
    def reload_project_program(self, name: str, *, domain_path: str | None = None) -> Dict[str, Any]:
        return self._sync_operations.reload_project_program(name, domain_path=domain_path)
    ...
    def get_version_history(
        ...
        *,
        ...
        return self._sync_operations.get_version_history(name, domain_path=domain_path, limit=limit)
    ...
    def get_version_diff(
        ...
        *,
        ...
        return self._sync_operations.get_version_diff(
            name,
    ...
    def close_session(self, name: str, *, remove_program: bool = False) -> None:
        self._target_lifecycle.close_session(name, remove_program=remove_program)

    def close_all(self) -> None:
        self._target_lifecycle.close_all()
    ...
    def call(
        ...
        return self._core_execution.call(command, params, target=target)
