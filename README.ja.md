...
- バージョン 0.1.5 で Ghidra 12.1.3 に対応しました。公式 12.1.3 ZIP には `linux_arm_64`、`mac_arm_64`、`mac_x86_64` の decompiler directory が含まれないため、公式 12.1.3 source tag から対応する `decompile` / `sleigh` をビルドし、overlay と適用済み Ghidra bundle の両方をリリースします。
